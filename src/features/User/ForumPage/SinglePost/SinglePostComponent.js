...
function SinglePostComponent() {
    ...
    return (
        ...
        <div className=" " ref={el => contentWrapperRef.current = el}>
                ...
                <div className="max-w-[1092px] w-[100%] mx-auto mt-[20px] flex bodyWrapper">
                    <div className="w-[20%] fixed partRight" ref={el => partRight.current = el}>
                        <div className="mx-[48px]">
                            <p className="text-[18px] font-medium text-center ">{post[0]?.userId.fullName}</p>
                    ...
                    <div className="w-[60%] partLeft" ref={el => partLeft.current = el}>
                        <div>
                            <p className="font-bold text-[40px] mt-[-10px] postTitle ">{post[0]?.title}</p>
                            <div className="my-[20px] flex items-center justify-between">
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        <p className=''>{post[0]?.userId.fullName}</p>
                                        <div className="flex items-center">
                                            <p className=" opacity-[0.9] font-light text-[14px]">{moment(post[0]?.createdAt).fromNow()}</p>
                                ...
                                <div>
                                    <i className="cursor-pointer fa-regular fa-bookmark mr-[8px] post_Reaction "></i>
                                    <i className="cursor-pointer fa-solid fa-bookmark mr-[8px] text-[#d54253] post_Reaction__active " style={{ display: "none" }}></i>

                                    {window.screen.width <= 1070 ?
                                        <i className="text-[20px] mb-[4px] fa-regular fa-comment comment_Icon__open" onClick={() => {
                                            if (socket) {
                    ...
                    <div className="fixed w-[100%] top-0 bottom-0 z-10 right-0 bg-[rgba(0,0,0,0.2)] comment_Wrapper hidden" ref={el => comment_Wrapper.current = el}>
                        <div className="comment_Content w-[50%] bg-[#fafafa] absolute right-0 top-0 bottom-0 pt-[50px] pb-[60px] px-[40px] overflow-y-auto">
                            <div className="w-full text-right">
                                <i className="comment_Icon__close absolute top-[13%] right-[4%] z-50 fa-solid fa-xmark text-[24px] cursor-pointer py-[10px] pl-[10px]" onClick={() => {
                                    comment_Wrapper.current.style.display = 'none'
                                }}></i>
                            </div>

                            <div className=''>
                                <p className="text-[20px] font-medium mt-[6%] mb-[50px]">{commentCount} bình luận</p>
                                <div className="">
