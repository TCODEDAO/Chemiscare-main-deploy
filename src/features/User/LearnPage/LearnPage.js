                                ...
                                <div>
                                    <div className="flex text-[#111827] boardBody">
                                        ...
                                        <div className="flex items-center justify-center w-[200px] px-5 py-2 bg-[#fafafa] border-[1px] border-[#111827] boardBodyItem">
                                            ...
                                            {(currentUserProcess[0]?.isCompleteRender === true || currentRound > 3) ? <button className="bg-[#3f3f46] text-white px-3 py-2 rounded-md disabled:opacity-25 hover:bg-[#4e4e57] examButtonInMobile hidden fixHidenMoblie" disabled>Hoàn thành</button> : <button className="examButtonInMobile hidden bg-[#3f3f46] text-white px-3 py-2 rounded-md hover:bg-[#4e4e57]  fixHidenMoblie" onClick={()=>handleJoinInTask(1)}>Làm </button>}
                                    ...
                                    <div className="flex text-[#111827] boardBody">
                                        ...
                                        <div className="flex items-center justify-center w-[200px] px-5 py-2 bg-[#fafafa] border-[1px] border-[#111827] boardBodyItem">
                                            ...
                                            {(currentUserProcess[1]?.isCompleteRender === true || currentRound > 3) ? <button className="bg-[#3f3f46] text-white px-3 py-2 rounded-md disabled:opacity-25 hover:bg-[#4e4e57] examButtonInMobile hidden fixHidenMoblie" disabled>Hoàn thành</button> : <button className="examButtonInMobile hidden bg-[#3f3f46] text-white px-3 py-2 rounded-md hover:bg-[#4e4e57]  fixHidenMoblie" onClick={()=>handleJoinInTask(2)}>Làm </button>}
                                    ...
                                    <div className="flex text-[#111827] boardBody">
                                        ...
                                        <div className="flex items-center justify-center w-[200px] px-5 py-2 bg-[#fafafa] border-[1px] border-[#111827] boardBodyItem">
                                            ...
                                            {(currentUserProcess[2]?.isCompleteRender === true || currentRound > 3) ? <button className="bg-[#3f3f46] text-white px-3 py-2 rounded-md disabled:opacity-25 hover:bg-[#4e4e57] examButtonInMobile hidden fixHidenMoblie disabled:opacity-25" disabled>Hoàn thành</button> : <button className="examButtonInMobile hidden bg-[#3f3f46] text-white px-3 py-2 rounded-md hover:bg-[#4e4e57]  fixHidenMoblie" onClick={()=>handleJoinInTask(3)}>Làm </button>}
